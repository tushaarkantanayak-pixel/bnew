...
export default function ValidationStep({
  ...
  const fieldTwoLabel = game?.inputFieldTwo;
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Input Group */}
      <div className={`grid grid-cols-1 ${fieldTwoLabel ? "sm:grid-cols-2" : ""} gap-3`}>
        ...
        {fieldTwoLabel && (
          <div className="space-y-1.5">
            ...
            <div className="relative group">
              ...
              {game?.inputFieldTwoOptions && game.inputFieldTwoOptions.length > 0 ? (
                <>
                  ...
                  >
                    <option value="" disabled className="bg-[var(--card)] text-white">Select {fieldTwoLabel}</option>
                    {game.inputFieldTwoOptions.map((opt) => (
                      <option key={opt.value} value={opt.value} className="bg-[var(--card)] text-white font-medium text-sm">
                        {opt.label}
                      </option>
                    ))}
                  </select>
      ...
      <div className="pt-2">
        <RecentVerifiedPlayers
          ...
          onSelect={(player) => {
            ...
            if (setZoneId) setZoneId(player.zoneId || "");
          }}
        />
      </div>
    </div>
