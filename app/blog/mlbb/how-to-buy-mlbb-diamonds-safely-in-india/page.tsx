...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://bluebuff.in/blog/mlbb/how-to-buy-mlbb-diamonds-safely-in-india" },
};
...
export default function BlogPage() {
  return (
    ...
    >
      ...
      <p>
        When you use a professional store like <Link href="/games/mobile-legends988" className="text-[var(--accent)] underline transition-opacity">bluebuff.in</Link>, you get:
      </p>
      <ul>
