...
export const metadata: Metadata = {
    ...
    alternates: { canonical: "https://bluebuff.in/blog/mlbb/how-to-gift-mlbb-diamonds" },
};
            ...
            <div className="mt-20 pt-10 border-t border-[var(--border)]">
                ...
                <div className="space-y-8">
                    ...
                    <div className="group">
                        ...
                        <p className="text-sm opacity-60">Gifts from <strong>bluebuff.in</strong> are sent instantly. Most friends receive them in under 1 minute.</p>
                    </div>
                    <div className="group">
