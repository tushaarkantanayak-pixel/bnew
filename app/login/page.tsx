              ...
              <motion.div variants={containerVariants} className="space-y-6">
                  ...
                  >
                    ...
                    {loading ? (
                      ...
                      <div className="flex items-center gap-2 relative z-10">
                        ...
                        <span className="text-[11px] leading-none">{showOtpField ? "Verify & Login" : "Send OTP"}</span>
                      </div>
                    )}
                  </button>
                </motion.form>
                ...
                {/* GOOGLE SECTION (Always Available) */}
                 <motion.div variants={itemVariants} className={`relative flex justify-center w-full ${loading ? "opacity-50 pointer-events-none" : ""}`}>
                  <div className="relative bg-[var(--background)] rounded-full border border-[var(--border)] overflow-hidden">
                    <GoogleLogin
