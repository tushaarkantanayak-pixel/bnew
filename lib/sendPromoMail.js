    ...
    try {
      await transporter.sendMail({
        ...
        html: `
          ...
          <body>
            <div class="container">
              <img src="https://bluebuff.in/logoBB.png" alt="Logo" class="logo">
              ...
              <a href="https://bluebuff.in" class="cta">Visit Store</a>

              <div class="footer">
                <p class="footer-text"><strong>mlbbtopup.in</strong></p>
                <p class="footer-text">
                  <a href="https://bluebuff.in" class="footer-link">Home</a> • 
                  <a href="https://bluebuff.in" class="footer-link">Support</a>
                </p>
